...
| T-02 | `test_homepage_loads` | Startseite abrufbar | HTTP 200, HTML enthält «E-Scooter» | ✅ Bestanden |
...
| T-06 | `test_provider_can_create_scooter` | Anbieter legt neuen Scooter an | HTTP 200, Scooter `SC-9999` in Datenbank vorhanden | ✅ Bestanden |
...
|---|---|---|---|---|
| M-01 | Karte auf Startseite | Startseite öffnen, Karte prüfen | OpenStreetMap-Karte zeigt Bern mit Scooter-Markierungen | ✅ Bestanden |
